...
#define Q1 ((struct q *) p1)->q
#define Q2 ((struct q *) p2)->q
#define Q3 ((struct q *) p3)->q
#define Q4 ((struct q *) p4)->q

#define F1 ((struct f *) p1)->f
#define F2 ((struct f *) p2)->f
#define F3 ((struct f *) p3)->f
...
extern void snprintexpr(char *, int, U *);
extern void print(FILE *, U *);
extern void print_expr(U *);
extern int sign_of_term(U *);
