...
\bigskip
Solution: See the book, p. 273. If $X\sim N(\mu,\sigma^2)$ then
$${X-\mu\over\sigma}\sim N(0,1)$$
This is close but we need to scale the denominator. From the bottom of p. 273,
$$\sigma_Z^2=E\left[\left({\overline X-\mu\over\sigma}\right)^2\right]
={E[(\overline X-\mu)^2]\over\sigma^2}={\sigma^2\over\sigma^2}=1$$
Hence
$${X-\mu\over r\sigma}\sim N(0,1/r^2)$$
We have
$$r=1/2,\qquad\mu=80,\qquad\sigma^2=100$$
therefore
$${\overline Y-80\over5}\sim N(0,4)$$
